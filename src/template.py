...
<link rel="canonical" href="https://syntaur.app/">
...
{{
  ...
  "@graph": [
    {{
      "@type": "Organization",
      "@id": "https://syntaur.app/#org",
      "name": "Syntaur Systems",
      "url": "https://syntaur.app",
      "logo": "https://syntaur.app/icon.png",
      "email": "partnerships@syntaur.app",
      "sameAs": ["https://github.com/syntaur-systems"],
      "location": {{
        "@type": "Place",
        "address": {{
          "@type": "PostalAddress",
    ...
    {{
      ...
      "@id": "https://syntaur.app/#app",
      "name": "Syntaur",
      "applicationCategory": "Personal AI platform",
      "operatingSystem": "Linux, macOS, Windows",
      "description": "Personal AI platform — one binary that consolidates smart home, finances, scheduling, voice, and communications into a single consistent interface.",
      "url": "https://syntaur.app",
      "downloadUrl": "https://github.com/syntaur-systems/syntaur/releases/latest",
      "publisher": {{ "@id": "https://syntaur.app/#org" }},
      "offers": {{ "@type": "Offer", "price": "0", "priceCurrency": "USD" }}
    }},
    {{
      "@type": "WebSite",
      "@id": "https://syntaur.app/#site",
      "url": "https://syntaur.app",
      "name": "Syntaur",
      "publisher": {{ "@id": "https://syntaur.app/#org" }}
    }}
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .device-frame {{
    ...
    margin: 0 auto;
    border-radius: 12px;
    box-shadow: 0 24px 60px rgba(10, 20, 32, 0.18), 0 8px 16px rgba(10, 20, 32, 0.08);
    overflow: hidden;
    background: #0a1420;
  ...
  .device-chrome {{
    ...
    gap: 6px;
    padding: 10px 14px;
    background: linear-gradient(180deg, #e9ecf1 0%, #dadfe6 100%);
  ...
  .device-chrome .device-url {{
    ...
    /* offset so the dots don't push the URL off-center */
  ...
  @media (max-width: 820px) {{
    ...
    .device-frame {{ max-width: 100%; border-radius: 8px; }}
    .device-chrome .device-url {{ font-size: 10px; padding: 2px 8px; transform: none; }}
...
<section id="preview" style="padding: 64px 0 32px;">
  <div class="container" style="text-align:center;">
    <div class="eyebrow" style="margin-bottom:18px;">An early look</div>
